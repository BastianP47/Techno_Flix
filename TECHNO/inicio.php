...
<main>
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src ="https://br.atsit.in/es/wp-content/uploads/2021/06/10-mejores-formas-de-arreglar-el-cursor-del-mouse-moviendose-solo-en-windows-10.jpg" width="100" height="100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
      ...
      <div class="carousel-item">
        <img src ="images/controlps4.jpg" width="100" height="100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
      ...
      <div class="carousel-item">
        <img src ="images/balaca.jpg" width="100" height="100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">Mas Productos Disponibles Te volaran la mente!!</h2>
        <p class="lead">Pack de teclado y Mouse gamer con luces tambien personalizable no te lo pierdas!!!</p>
      </div>
      <div class="col-md-5">
        <img src ="https://dojiw2m9tvv09.cloudfront.net/23147/product/v100-m200-104-teclas-3-cores-gaming-teclado6068.jpg" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></svg>
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading">Diadema Gamer personalizada Busca el tuyo a tu gusto.</h2>
        <p class="lead">Puedes personalizar tu diadema gamer a tu gusto en el catalogo y menu de personalizacion</p>
      </div> 
      <div class="col-md-5 order-md-1">
        <img src="https://kessinger.cl/wp-content/uploads/2021/12/Captura-4.jpg" width="400" height="340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></svg>
      </div>
    </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">Y Por Ultimo Mouse Pads para adornar tu espacio</h2>
        <p class="lead">Ademas de la comodidad un adorno extra para acompañar tu espacio de trabajo o gamer a tu preferencia</p>
      </div>
      <div class="col-md-5">
        <img src ="images/pads.jpg" width="600" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em"></text></svg>
